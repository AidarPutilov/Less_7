...
- Добавлена возможность оплаты курсов через https://stripe.com/docs/api.
...
#### Базовые настройки
```
Ввести настройки django, сервера PostgreSQL, платёжной системы Stripe в файле .env.sample. Переименовать файл в .env.
```
